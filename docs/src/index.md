...
instructions](create_registry.md).
...
[Troubleshooting advice](troubleshooting_general.md) if you
...
instructions](register.md).

## Advanced Topics

* [Working with a Private Registry and/or Private Repositories](ssh_keys.md)
* [Registering a Package in a Subdirectory of a Repository](subdir.md)
* [Migrating Packages from the General Registry](migration_from_general.md)
* [Using LocalRegistry on a Shared Filesysem](shared_filesystem.md)
* [Delete a Registered Package](delete_package.md)
* [Registry Consistency Testing](registry_ci.md)